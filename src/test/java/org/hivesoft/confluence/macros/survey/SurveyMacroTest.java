...
public class SurveyMacroTest {
  ...
  SurveyMacro classUnderTest = new SurveyMacro(mockPageManager, mockContentPropertyManager, mockPermissionEvaluator, mockTemplateRenderer, mockXhtmlContent, mockPluginSettingsFactory, mockVelocityAbstractionHelper);
